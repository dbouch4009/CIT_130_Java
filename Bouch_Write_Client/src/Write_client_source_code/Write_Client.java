        ...
        userText.addActionListener(
                new ActionListener() {
                    public void actionPerformed(ActionEvent e) {
                        try
                        {
                            //This is a code block I was messing around with, trying to get the messages to push from the text file every 500 ms
                            // but was unable to achieve it.
                            /*
                            String info = "reader_file.txt";
                            File readerFile = new File(info);

                            info = readerFile.getAbsolutePath();
